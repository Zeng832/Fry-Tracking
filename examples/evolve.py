...
from yolov8.yolo.utils.checks import check_requirements, print_args
...
def parse_opt():
    ...
    parser.add_argument('--reid-model', type=str, default=WEIGHTS / 'resnet50_msmt17_combineall_256x128_amsgrad_ep150_stp60_lr0.0015_b64_fb10_softmax_labelsmooth_flip_jitter.pth')
